...
Primitive2::Primitive2(int primitiveID, std::string primitiveDes, MCCableRegraspController &)
...
void Primitive2::prim_config(double par1, double par2, MCCableRegraspController &)
{
    // Set parameter1.
    slideLen = par1;
    par2 = par2;
